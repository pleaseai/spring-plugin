...
- [ ] Skill instructions in `SKILL.md` contain no direct network-call directives — covered by FR-9. Verify this explicitly during T001 authoring and T010 documentation review.
