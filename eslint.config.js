      ...
      'no-restricted-imports': [
        'error',
        {
          paths: [
            ...
            { name: 'net', message: 'Library Layer has no network access.' },
            { name: 'node:net', message: 'Library Layer has no network access.' },
            { name: 'http', message: 'Library Layer has no network access.' },
            { name: 'node:http', message: 'Library Layer has no network access.' },
            { name: 'https', message: 'Library Layer has no network access.' },
